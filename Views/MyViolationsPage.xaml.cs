...
public partial class MyViolationsPage : Page
{
    public MyViolationsPage()
    {
        InitializeComponent();
        LoadDataGridReports();
    }
    ...
    {
        ReportViolation reportDAO = new ReportViolation();
    ...
    private void ReportDetailPage_Click(object sender, RoutedEventArgs e)
    {
        ...
        Application.Current.Properties["reportVio"] = report;
        var mainWindow = Window.GetWindow(this) as MainWindow;
        mainWindow.MainFrame.Content = new MyViolationDetail();
    }
}